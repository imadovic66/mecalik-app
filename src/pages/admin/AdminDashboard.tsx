...
export default function AdminDashboard() {
  ...
  // ── Fetch finance data when tab is active ──
  useEffect(() => {
      ...
      <div className="lg:ml-[220px] flex-1 min-h-screen" style={{ overflow: 'auto', background: '#080808' }}>
        ...
        <div style={{ padding: '28px 32px' }}>
          ...
          {activeTab === 'finances' && (() => {
            ...
            const avgPerService = financeBookings.length
              ? Math.round(totalRevenue / financeBookings.length)
              : 0
            ...
            // Pricing grid data (kept from original)
            ...
            const avgMO = moServices.length
              ? Math.round(moServices.reduce((sum, s) => sum + (s[selectedZone] as number) * 0.4, 0) / moServices.length) : 0
            ...
            const avgParts = partsServices.length
              ? Math.round(partsServices.reduce((sum, s) => sum + ((s.typicalPartsCost!.min + s.typicalPartsCost!.max) / 2 * 0.05), 0) / partsServices.length) : 0
              ...
              <>
                ...
                {financeLoading ? (
                  ...
                  <>
                    ...
                    <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
                      {[
                        ...
                        <div key={kpi.label} style={cardStyle}>
                          ...
                          <div className="text-2xl font-bold" style={{ color: 'white', fontFamily: 'Space Grotesk, sans-serif' }}>
                            {kpi.value}
                          </div>
                        </div>
                      ))}
                    ...
                    {/* ── SECTION 4 & 5: TRANSACTIONS + B2B/B2C SPLIT ── */}
                      ...
                      <div className="lg:col-span-4 rounded-xl p-6" style={{ background: 'rgba(255,255,255,0.04)', border: '1px solid rgba(255,255,255,0.08)' }}>
                        ...
                        <div className="space-y-5">
                          <div className="p-4 rounded-xl" style={{ background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.06)' }}>
                            ...
                            <div className="text-2xl font-bold mb-1" style={{ color: 'white', fontFamily: 'Space Grotesk, sans-serif' }}>
                              {b2cRevenue.toLocaleString()} MAD
                            </div>
                            <div className="text-xs" style={{ color: 'rgba(255,255,255,0.4)' }}>
                              {b2cBookings.length} {t('admin.finance.interventions')}
                            </div>
                          </div>
                          <div className="p-4 rounded-xl" style={{ background: 'rgba(240,192,64,0.04)', border: '1px solid rgba(240,192,64,0.12)' }}>
                            ...
                            <div className="text-2xl font-bold mb-1" style={{ color: 'white', fontFamily: 'Space Grotesk, sans-serif' }}>
                              {b2bRevenue.toLocaleString()} MAD
                            </div>
                            <div className="text-xs" style={{ color: 'rgba(255,255,255,0.4)' }}>
                              {b2bBookings.length} {t('admin.finance.interventions')}
                            </div>
                          </div>
                        </div>
                      </div>
                ...
                <div className="mt-4 mb-4">
                  <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
                    <h3 className="text-base font-semibold" style={{ color: 'rgba(255,255,255,0.7)' }}>
                      Grille tarifaire
                    </h3>
