  ...
  return (
    <main style={{ background: '#0A0A0A', color: 'white', fontFamily: 'Outfit, sans-serif', minHeight: '100vh', paddingTop: '80px' }}>
      ...
      <section style={{ padding: '80px 5% 60px', maxWidth: '1200px', margin: '0 auto' }}>
        <div style={{ display: 'inline-block', background: 'rgba(240,192,64,0.1)', border: '1px solid rgba(240,192,64,0.3)', borderRadius: '100px', padding: '6px 16px', marginBottom: '24px', fontSize: '12px', color: '#F0C040', letterSpacing: '0.1em', textTransform: 'uppercase' }}>
          {t('flottes.pageTitle')}
        </div>
        ...
        <div style={{ display: 'flex', gap: '16px', flexWrap: 'wrap' }}>
          <a href="https://wa.me/212777348065" style={{ background: '#F0C040', color: '#0A0A0A', padding: '14px 28px', borderRadius: '12px', fontWeight: 700, textDecoration: 'none' }}>
      ...
      <section style={{ padding: '60px 5%', maxWidth: '1200px', margin: '0 auto' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(240px,1fr))', gap: '16px' }}>
          {[t('flottes.problem1'), t('flottes.problem2'), t('flottes.problem3'), t('flottes.problem4')].map((p, i) => (
            <div key={i} style={{ background: 'rgba(255,60,60,0.05)', border: '1px solid rgba(255,60,60,0.15)', borderRadius: '14px', padding: '24px', display: 'flex', gap: '12px', alignItems: 'flex-start' }}>
              <span style={{ color: '#FF4444', fontSize: '18px', marginTop: '2px' }}>✗</span>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(260px,1fr))', gap: '24px' }}>
          {[
            ...
            <div key={i} style={{ background: 'rgba(67,188,201,0.05)', border: '1px solid rgba(67,188,201,0.15)', borderRadius: '16px', padding: '28px' }}>
              <div style={{ width: '32px', height: '32px', background: 'rgba(67,188,201,0.15)', borderRadius: '8px', display: 'flex', alignItems: 'center', justifyContent: 'center', marginBottom: '16px', color: '#43BCC9', fontWeight: 800 }}>{i + 1}</div>
      ...
      <section style={{ padding: '80px 5%', textAlign: 'center', background: 'rgba(240,192,64,0.03)' }}>
        ...
        <div style={{ display: 'flex', gap: '16px', justifyContent: 'center', flexWrap: 'wrap' }}>
          <a href="https://wa.me/212777348065" style={{ background: '#F0C040', color: '#0A0A0A', padding: '16px 36px', borderRadius: '14px', fontWeight: 800, textDecoration: 'none' }}>
